...
function Navbar() {
  ...
  return (
    <div className="fixed z-[999] w-full text-2xl px-20 py-8 flex justify-between items-center">
      <h3>
      ...
      <div className="links flex justify-between items-center gap-10">
        {["Home", "My Work", "About", "Insights", "Contact"].map(
          (item, index) => (
            <a
              key={index}
              className={`text-md p-1 flex justify-between items-center font-regular capitalize cursor-pointer ${
                index === 4 && "ml-32"
              }`}
              onClick={
                item === "About"
