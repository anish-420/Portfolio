...
function Footer() {
  return (
    <div id="footer-section" className="flex gap-20 w-full h-screen bg-zinc-900 p-20 font-mono">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[5vw] uppercase leading-none font-semibold -mb-3">
            Hobbies
      ...
      <div className="w-1/2">
        <h1 className="text-[5vw] uppercase leading-none font-semibold mb-5">
          Contacts
        </h1>
        <div className="details font-mono mt-10">
          <a className="block text-xl font-light" href="https://www.instagram.com/anissssh__/">Instagram</a>
          <a className="block text-xl font-light" href="https://github.com/anish-420">GitHub</a>
          <a className="block text-xl font-light" href="https://www.instagram.com/anissssh__/">Facebook</a>
          <a className="block text-xl font-light" href="https://www.instagram.com/anissssh__/">Twitter</a>
        </div>
      </div>
    </div>
  );
