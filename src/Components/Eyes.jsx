      ...
      <div data-scroll data-scroll-speed="-.7" className='relative w-full h-screen bg-cover bg-center bg-[url("https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-scaled.jpg")]'>
        <div className="absolute gap-10 flex top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%]">
          <div className="flex items-center justify-center w-[15vw] h-[15vw] rounded-full bg-slate-100">
            <div className="relative flex justify-center items-center w-2/3 h-2/3 rounded-full  bg-black">
              <h1 className="flex justify-center items-center capitalize font-serif text-4xl font-semibold p-20">
                play
              </h1>
              <div
                style={{
          ...
          <div className="flex items-center justify-center w-[15vw] h-[15vw] rounded-full bg-slate-100">
            <div className="relative flex justify-center items-center w-2/3 h-2/3 rounded-full  bg-black">
              <h1 className="flex justify-center items-center capitalize font-serif font-semibold text-4xl p-20">
                play
              </h1>
              <div
                style={{
